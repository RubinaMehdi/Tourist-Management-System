...
public class Hotel implements Displayable {
    ...
    // CONSTRUCTOR
    public Hotel(String hotelID, String name, String location, int starRating, double pricePerNight,
            int availableRooms) {
    ...
    public static Hotel fromFileString(String line) {
        String[] p = line.split(",");
        return new Hotel(p[0], p[1], p[2], Integer.parseInt(p[3]), Double.parseDouble(p[4]), Integer.parseInt(p[5]));
    }
}
