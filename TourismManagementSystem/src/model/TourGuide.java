...
class TourGuide extends Person implements Manageable, Serializable {
    ...
    // add a package to this guide's list (aggregation - package exists on its own
    // too)
    ...
    public void showMenu() {
        ...
        System.out.println("2. View Tourists");
