...
public class Tourist extends Person implements Displayable {
    ...
    //CONSTRUCTOR
    public Tourist(String personID, String name, String email, String password, String nationality, String passportNumber, String contactNumber, int groupSize) {
